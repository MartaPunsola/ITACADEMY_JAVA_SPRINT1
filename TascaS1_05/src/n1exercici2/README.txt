...
For example: javac n1exercici2/Main_n1exercici2.java
...
For example: java n1exercici2/Main_n1exercici2 n1exercici2

The program will recursively list the files of the directory.
