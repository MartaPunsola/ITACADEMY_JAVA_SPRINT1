...
For example: javac n1exercici1/Main_n1exercici1.java
...
For example: java n1exercici1/Main_n1exercici1 n1exercici1

The program will list the files of the directory.
